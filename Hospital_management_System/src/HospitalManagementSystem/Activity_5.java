...
public class Activity_5 extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
       ...
       establishconnection ob=new establishconnection();
        checkcode= "select * from patient where checkup='"+today+"';";
        try{
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
     ...
     txtyyyy.setText("");
       ...
       code="insert into patient values("+pno+",'"+txt_patientname.getText()+"',"+Integer.parseInt(txt_patientage.getText())+",'"+txt_patientaddress.getText()+"','"+txt_patientdoctor.getText()+"','"+date+"','"+txt_credit.getText()+"','"+txt_debit.getText()+"','"+txt_remaining.getText()+"','Y','"+admsndate+"','"+txt_bedno.getText()+"',"+Integer.parseInt(txtcontacts.getText())+",'"+txtarea_medicdetails.getText()+"');";
        }
       else if(optnotadmit.isSelected()==true)
            code="insert into patient values("+pno+",'"+txt_patientname.getText()+"',"+Integer.parseInt(txt_patientage.getText())+",'"+txt_patientaddress.getText()+"','"+txt_patientdoctor.getText()+"','"+date+"','"+txt_credit.getText()+"','"+txt_debit.getText()+"','"+txt_remaining.getText()+"',"+"default,"+"default,"+"default,'"+txtcontacts.getText()+"','"+txtarea_medicdetails.getText()+"');";
